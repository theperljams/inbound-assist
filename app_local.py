...
# Create inbox but skip webhook creation for local testing
...
# Skip webhook creation for local testing
print("⚠️  Skipping webhook creation for local testing")
...
"""
    ...
    # For local testing, just print the response instead of sending email
    print("📧 Would send email reply:")
    print("=" * 50)
